...
| Acceptance Criteria | `hints/review-hints.md` | Content from a `## Acceptance Criteria` section — quality gates and QA definition of done; also route to `hints/tasks-hints.md` as test scenarios |
