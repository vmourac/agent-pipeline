...
| **Command naming** | `/criar-prd`, `/criar-techspec`, `/criar-tasks`, `/executar-task`, `/executar-review`, `/executar-qa`, `/executar-bugfix` | `PRD Agent`, `TechSpec Agent`, `Tasks Agent`, `Task Implementation Agent`, `Review Agent`, `QA Agent`, `Bugfix Agent` |
